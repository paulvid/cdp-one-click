...
#az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-knox-nsg -n knox_gateway_cldr --priority 104 --source-address-prefixes '52.36.110.208/32' '52.40.165.49/32' '35.166.86.177/32' --destination-address-prefixes '*'  --destination-port-ranges 443 --direction Inbound --access Allow --protocol Tcp --description "Allow knox access from control CIDR."
az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-knox-nsg -n control_plane --priority 104 --source-address-prefixes "$sg_cidr" --destination-address-prefixes '*'  --destination-port-ranges 9443 --direction Inbound --access Allow --protocol Tcp --description "Allow control plane access."
#az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-knox-nsg -n control_plane_cldr --priority 106 --source-address-prefixes '52.36.110.208/32' '52.40.165.49/32' '35.166.86.177/32' --destination-address-prefixes '*'  --destination-port-ranges 9443 --direction Inbound --access Allow --protocol Tcp --description "Allow control plane access from CIDR."
az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-knox-nsg -n outbound --priority 105 --source-address-prefixes '*' --destination-address-prefixes '*'  --destination-port-ranges '*' --direction Outbound --access Allow --protocol '*' --description "Allow outbound access."
...
#az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-default-nsg -n knox_gateway_cldr --priority 104 --source-address-prefixes '52.36.110.208/32' '52.40.165.49/32' '35.166.86.177/32' --destination-address-prefixes '*'  --destination-port-ranges 443 --direction Inbound --access Allow --protocol Tcp --description "Allow knox access from control CIDR."
az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-default-nsg -n control_plane --priority 104 --source-address-prefixes "$sg_cidr" --destination-address-prefixes '*'  --destination-port-ranges 9443 --direction Inbound --access Allow --protocol Tcp --description "Allow control plane access."
#az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-default-nsg -n control_plane_cldr --priority 106 --source-address-prefixes '52.36.110.208/32' '52.40.165.49/32' '35.166.86.177/32' --destination-address-prefixes '*'  --destination-port-ranges 9443 --direction Inbound --access Allow --protocol Tcp --description "Allow control plane access from CIDR."
az network nsg rule create -g $prefix-cdp-rg --nsg-name $prefix-default-nsg -n outbound --priority 105 --source-address-prefixes '*' --destination-address-prefixes '*'  --destination-port-ranges '*' --direction Outbound --access Allow --protocol '*' --description "Allow outbound access."
